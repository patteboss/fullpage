...
gameState.prototype = {
    ...
    initKeyboard: function () {
        ...
        this.key_fire = game.input.keyboard.addKey(Phaser.Keyboard.K);
...
var game = new Phaser.Game(gameProperties.screenWidth, gameProperties.screenHeight, Phaser.AUTO, 'gameDiv2');
